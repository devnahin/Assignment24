    ...
    <section id="speakers-details" class="wow fadeIn">
      <div class="container">
        <div class="section-header">
          <h2>Login</h2>
          <p>Login to register an Event</p>
        </div>

        <div class="row">
          <div class="col-md-6">
            <img src="img/venue-gallery/LoginPageImg.jpg" alt="Speaker 1" class="img-fluid">
          </div>
          <div class="col-md-6">
            <div class="details">
                <h3><b>Login</b></h3>
                <form action="loginUser" method="post" enctype="multipart/form-data">
                  ...
                  <input type="password" name="PassW" class="form-control"> <br>

                  <input type="submit" class="btn btn-primary"> <label for="NewUser">&nbsp;&nbsp; New User? <a href="{{ url('/Register') }}">Create New Account</a></label>
                </form>
            </div>
          </div>
          <!-- <div class="col-md-6">
