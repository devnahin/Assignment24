    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="{{ url('/bookEvent') }}">Logout</a></li>
    ...
    <section id="registerForm" class="wow fadeIn">
      <div class="container container-b">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div id="ui">
                    <form action="registerEvent" method="POST" class="form-group">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                <label for="">Event type:</label>
                                <select name="Eventtype" id="" class="form-control">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="eventPurpose" class="form-control">
                            </div>
                        </div><br>
                        <div class="row">
                            <div class="col-lg-12">
                                <label for="">Desired Location:</label>
