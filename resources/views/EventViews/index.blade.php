...
<head>
  ...
  <!--This Code not Working <link rel="stylesheet" href="{{ asset('resources/css/style.css') }}"> -->
...
<body>
    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="buy-tickets"><a href="{{ url('/bookEvent') }}">Book Event</a></li>
        </ul>
  ...
  <section id="intro">
    <div class="intro-container wow fadeIn">
      <h1 class="mb-4 pb-0">Prime Event<br><span>Event Management</span> Company</h1>
      <p class="mb-4 pb-0">Life is an event. Make it memorable.</p>
      <!-- <a href="https://www.instagram.com/tv/CZ2J4qwAcKl/?igshid=YmMyMTA2M2Y=" class="venobox play-btn mb-4" data-vbtype="video"
...
Today, Prime events has been acknowledged as a pioneer in event management of Corporate Events, Weddings, Award Galas, Conferences, Product Launches, Outdoor Stage Shows, Festivals, Premiere Live Entertainments, Fashion Shows etc.</p>
          ...
          <div class="col-lg-4">
            <h3>Where</h3>
            <p>Central Tower,8th Floor, Kochi - 682506</p>
          </div>
          <!-- <div class="col-lg-3">
            <h3>When</h3>
    ...
    <section id="speakers" class="wow fadeInUp">
      <div class="container">
        <div class="section-header">
          <h2>Events</h2>
          <p>Here are some of the Events We Represented</p>
        </div>
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-address">
              ...
              <h3>Address</h3>
              <address>Central Tower, 8th Floor, Kochi, Kerala,India.</address>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="contact-phone">
              ...
              <h3>Phone Number</h3>
              <p><a href="tel:+155895548855">+91 9400 600 720</a></p>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="contact-email">
              ...
              <h3>Email</h3>
              <p><a href="mailto:info@example.com">primeevent@media.com</a></p>
            </div>
          </div>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              Dhaka<br>
              <strong>Phone:</strong> 123 456 89<br>
              <strong>Email:</strong> example@media.com<br>
            </p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>Ostad Assignment </strong>. All Rights Reserved
      </div>
    </div>
  </footer><!-- #footer -->
